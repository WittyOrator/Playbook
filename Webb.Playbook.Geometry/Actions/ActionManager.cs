...
namespace Webb.Playbook.Geometry.Actions
{
    ...
    {
        public ActionManager(Drawing drawing)
        {
        ...
        public void RecordAction(IAction existingAction)
        {
            ...
            {
                throw new ArgumentNullException("ActionManager.RecordAction: the existingAction argument is null");
            }
        ...
        public void CheckNotRunningBeforeRecording(IAction existingAction)
        {
        ...
        public void CommitTransaction()
        {
            if (TransactionStack.Count == 0)
            {
                throw new InvalidOperationException(
                    ...
                    + " but use using(Transaction t = Transaction.Create(Root)) instead.");
            }
        ...
        public void Redo()
        {
            ...
            {
                throw new InvalidOperationException(
                    string.Format("ActionManager is currently busy"
