...
namespace Office_To_XPS
{
    public class OfficeToXps
    {
        ...
        public static OfficeToXpsConversionResult ConvertToXps(string sourceFilePath, ref string resultFilePath, ref int resultCount)
        {
            ...
            {
                return ConvertFromPowerPoint(sourceFilePath, ref resultFilePath, ref resultCount);
            }
